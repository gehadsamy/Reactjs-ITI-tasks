...
import { MDBCol, MDBCard, MDBCardImage, MDBCardBody, MDBBadge,  MDBContainer } from "mdb-react-ui-kit";
                        ...
                        <MDBCardBody className="col-md-8">
                            ...
                            <h5>
                                <strong>
                                    {product.category}
                <MDBContainer>
                    <ReactStars count={5} onChange={ratingChanged} size={24} isHalf={true} value={product.rating.rate} activeColor="#ffd700"/>
                </MDBContainer>
